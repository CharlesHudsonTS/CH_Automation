...
public class GlobalMessagesTest extends AbstractTestCaseReport implements FileConstants
{
    ...
    public void verifyCloseButtonFunctionality() throws Exception
    {
        ...
        while (retry.retry())
        {
            try
            {
                ...
                testcase.assertTrue(HomePage.isPromotionalContent(), "Promotion Content Should display",
                        "Promotion Content Should display");
                HomePage.clickOnClosePromoOffer();
                SeleniumUtils.wait(2);
                testcase.assertFalse(HomePage.isPromotionalContent(), "System should not display Promotional Content",
                        "System should display Promotional Content");
                testcase.pass(
    ...
    public void displayOfSystemAlert() throws Exception
    {
        ...
        while (retry.retry())
        {
            ...
            {
                tyreURL();
                testcase.assertTrue(HomePage.isSystemAlert(), "System should display System Alert",
    ...
    public void verifySystemAlertCloseButton() throws Exception
    {
        ...
        while (retry.retry())
        {
            try
            {
                ...
                testcase.assertTrue(HomePage.isSystemAlert(), "System should display System Alert",
                        "System is not displaying System Alert");
                HomePage.clickOnSystemAlertClose();
                testcase.assertFalse(HomePage.isSystemAlert(), "System should not display System alert",
    ...
    public void displayofPromoMsg() throws Exception
    {
        ...
        while (retry.retry())
        {
            ...
            {
                tyreURL();
                testcase.assertTrue(HomePage.isPromotionalContent(), "System should display Promotional Content",
                        "System is not displaying Promotional Content");
                SeleniumUtils.javaScriptExecutorDown("250");
                SeleniumUtils.wait(3);
                testcase.assertFalse(HomePage.isPromotionalContent(),
    ...
    public void displayOfSytemAlert() throws Exception
    {
        ...
        while (retry.retry())
        {
            ...
            {
                tyreURL();
                testcase.assertTrue(HomePage.isSystemAlert(), "System should display Promotional Content",
                        "System is not displaying Promotional Content");
    ...
    @Test
    public void displayOfBothAlerts() throws Exception
    {
        String name = new Object()
        {}.getClass().getEnclosingMethod().getName();
        TestCaseDetail testcase = TestCaseFactory.createTestCaseDetail(this.getClass(), name);
