...
import com.ch.ta.mobilePages.MobilePredictiveSearchPage;
import com.ch.ta.utils.CommonUtils;
import com.ch.utils.DriverFactory;
import com.ch.utils.SeleniumUtils;

public class MobilePredictiveSearchTest extends AbstractTestCaseReport
{
    ...
    public void verifySearchIconTest() throws Exception
    {
        ...
        while (retry.retry())
        {
            try
            {
                ...
                testcase.assertTrue(MobilePredictiveSearchPage.verifySearchTextBox(),
    ...
    // To verify the display of 'Search' component on clicking search icon in
    ...
    public void verifySearchCompTest() throws Exception
    {
        ...
        while (retry.retry())
        {
            try
            {
                ...
                MobileHeaderFooterPage.clickHamburgerSearchMenu();
                SeleniumUtils.wait(5);
                MobilePredictiveSearchPage.clickSearchTextBox();
                SeleniumUtils.wait(5);
                testcase.assertTrue(PredictiveSearchPage.verifySearchComponents(),
                        "Search components should be displayed", "Search components should not be displayed");
                testcase.assertEquals("RECENT SEARCHES",
                        SeleniumUtils.getText(ExcelProperty.getElementValue(PREDICTIVE_SEARCH, HEADER_LOGO)));
                testcase.assertEquals("POPULAR SEARCHES",
                        SeleniumUtils.getText(ExcelProperty.getElementValue(PREDICTIVE_SEARCH, HEADER_LOGO)));
                testcase.assertEquals("KNOWLEDGE",
                        SeleniumUtils.getText(ExcelProperty.getElementValue(PREDICTIVE_SEARCH, HEADER_LOGO)));
    ...
    // To verify the display and functionality of close icon 'X' in 'Search'
    // component.
    @Test
    ...
    // To verify the 'Search' component on entering invalid search data in the
    // 'Search' text box.
    @Test
    public void invalidSearchData() throws Exception
    {
        ...
        while (retry.retry())
        {
            try
            {
                ...
                SeleniumUtils.wait(5);
                testcase.assertEquals("No results found, but here are some other ways to search:",
                        SeleniumUtils.getText(ExcelProperty.getElementValue(PREDICTIVE_SEARCH, HEADER_LOGO)));
                testcase.assertTrue(PredictiveSearchPage.verifySearchComponents(),
                        "Search components should be displayed", "Search components should not be displayed");
                testcase.assertEquals("RECENT SEARCHES",
                ...
                testcase.assertEquals("KNOWLEDGE",
                        SeleniumUtils.getText(ExcelProperty.getElementValue(PREDICTIVE_SEARCH, HEADER_LOGO)));
                testcase.assertTrue(PredictiveSearchPage.isShopByVehicle(), "Shop By Vehicle icon is displayed",
                        "Shop By Vehicle icon is displayed");
                testcase.assertTrue(PredictiveSearchPage.isShopByBrand(), "Shop By Brand icon is displayed",
                        "Shop By Brand icon is displayed");
                testcase.assertTrue(PredictiveSearchPage.isShopByTireType(), "Shop By Tire Type icon is displayed",
                        "Shop By Tire Type icon is displayed");
                testcase.assertTrue(PredictiveSearchPage.isShopByDeals(), "Shop By Deals icon is displayed",
                        "Shop By Deals icon is displayed");
    ...
    // To verify the functionality of 'Shop By Vehicle' icon in 'No Results
    // found' page of 'Search' component.
    @Test
    public void shopByVehicleIcon() throws Exception
    {
        ...
        while (retry.retry())
        {
            try
            {
                ...
                SeleniumUtils.wait(5);
                testcase.assertTrue(
                        SeleniumUtils.iSDisplayed(ExcelProperty.getElementValue(PREDICTIVE_SEARCH, HEADER_LOGO)),
                        "Navigated to Shop By Vehicle page", "Not navigated to Shop By Vehicle page");
    ...
    // To verify the functionality of 'Shop By Brand' icon in 'No Results found'
    // page of 'Search' component.
    @Test
    public void shopByBrandIcon() throws Exception
    {
        ...
        while (retry.retry())
        {
            try
            {
                ...
                testcase.assertTrue(
                        SeleniumUtils.iSDisplayed(ExcelProperty.getElementValue(PREDICTIVE_SEARCH, HEADER_LOGO)),
                        "Navigated to Shop By Brand page", "Not navigated to Shop By Brand page");
    ...
    // To verify the functionality of 'Shop By Tire Type' icon in 'No Results
    // found' page of 'Search' component.
    @Test
    ...
    // To verify the functionality of 'Shop By Deals' icon in 'No Results found'
    // page of 'Search' component.
    @Test
    ...
    // To verify the predictive search on entering a query in search text box of
    // 'Search' component .
    @Test
    public void predictiveSearchTest() throws Exception
    {
        ...
        while (retry.retry())
        {
            try
            {
                ...
                SeleniumUtils.wait(5);
                String suggestion1 = SeleniumUtils
                        .getText(ExcelProperty.getElementValue(PREDICTIVE_SEARCH, HEADER_LOGO));
                // String suggestion2 =
                // SeleniumUtils.getText(ExcelProperty.getElementValue(PREDICTIVE_SEARCH,
                // HEADER_LOGO));
    ...
    // To verify the display of 'Search' component on entering a query in search
    // text box of 'Search' component .
    @Test
    public void searchComponentSearchResults() throws Exception
    {
        ...
        while (retry.retry())
        {
            try
            {
                ...
                PredictiveSearchPage.enterSearchData("services");
                SeleniumUtils.wait(5);
                testcase.assertEquals("PRODUCTS",
                        SeleniumUtils.getText(ExcelProperty.getElementValue(PREDICTIVE_SEARCH, HEADER_LOGO)));
                testcase.assertEquals("KNOWLEDGE",
                        SeleniumUtils.getText(ExcelProperty.getElementValue(PREDICTIVE_SEARCH, HEADER_LOGO)));
    ...
    // To verify the functionality of products in carousels of 'Search'
    // component on searching for a query.
    @Test
    public void clickAnyProductSearchResults() throws Exception
    {
        ...
        while (retry.retry())
        {
            try
            {
                ...
                testcase.assertTrue(
                        SeleniumUtils.iSDisplayed(ExcelProperty.getElementValue(PREDICTIVE_SEARCH, HEADER_LOGO)),
                        "Navigated to PDP", "Not navigated to PDP");
                testcase.pass("functionality of  products in carousels of 'Search' component on searching for a query");
                break;
            } catch (Exception e)
            {
                testcase.retry("functionality of  products in carousels of 'Search' component on searching for a query",
                        testcase, retry, e);
                e.printStackTrace();
            }
        }
    ...
    // To verify the functionality of 'View all ## results' link in products in
    // carousels of 'Search' component on searching for a query.
    @Test
    public void clickViewAllProducts() throws Exception
    {
        ...
        while (retry.retry())
        {
            try
            {
                ...
                testcase.assertTrue(
                        SeleniumUtils.iSDisplayed(ExcelProperty.getElementValue(PREDICTIVE_SEARCH, HEADER_LOGO)),
                        "Other relted products are displayed", "Other relted products are not displayed");
                testcase.pass(
                        "functionality of 'View all ## results' link in products in carousels of 'Search' component on searching for a query");
                break;
            } catch (Exception e)
            {
                testcase.retry(
    ...
    // To verify the functionality of articles listed in 'Knowledge' section of
    // 'Search' component on searching for a query.
    @Test
    public void clickAnyKnowledgeArticles() throws Exception
    {
        ...
        while (retry.retry())
        {
            try
            {
                ...
                testcase.assertTrue(
                        SeleniumUtils.iSDisplayed(ExcelProperty.getElementValue(PREDICTIVE_SEARCH, HEADER_LOGO)),
                        "Navigated to article page", "Not navigated to article page");
                testcase.pass(
                        "functionality of articles listed in 'Knowledge' section of 'Search' component on searching for a query.");
                break;
            } catch (Exception e)
            {
                testcase.retry(
    ...
    // To verify the functionality of 'View all ## results' link in 'Knowledge'
    // section of 'Search' component on searching for a query.
    @Test
    public void clickViewAllKnowledgeArticles() throws Exception
    {
        ...
        while (retry.retry())
        {
            try
            {
                ...
                testcase.assertTrue(
                        SeleniumUtils.iSDisplayed(ExcelProperty.getElementValue(PREDICTIVE_SEARCH, HEADER_LOGO)),
                        "Other related articles are displayed", "Other related articles are not displayed");
                testcase.pass(
                        "functionality of 'View all ## results' link in 'Knowledge' section of 'Search' component on searching for a query.");
                break;
            } catch (Exception e)
            {
                testcase.retry(
    ...
    // To verify the predictive search on entering a brand name in search text
    // box of 'Search' component .
    @Test
    ...
    // To verify the display of 'Search' component on entering a brand name in
    // search text box of 'Search' component .
    @Test
    ...
    // To verify the functionality of products in carousels of 'Search'
    // component on searching for brands.
    @Test
    public void productCarouselsForBrands() throws Exception
    {
        ...
        while (retry.retry())
        {
            ...
            {
                testcase.retry("functionality of  products in carousels of 'Search' component on searching for brands.",
                        testcase, retry, e);
                e.printStackTrace();
            }
        }
    ...
    // To verify the functionality of 'View all ## results' link in products in
    // carousels of 'Search' component on searching 'Brands'.
    @Test
        ...
        while (retry.retry())
        {
            try
            {
                ...
                testcase.assertTrue(
                        ...
                        "Other relted products are displayed", "Other relted products are not displayed");
                testcase.pass(
                        "functionality of 'View all ## results' link in products in carousels of 'Search' component on searching 'Brands'.");
                break;
            } catch (Exception e)
            {
                testcase.retry(
    ...
    // To verify the functionality of brands in carousels of 'Search' component
    // on searching for brands.
    @Test
    public void clickAnyBrand() throws Exception
    {
        ...
        while (retry.retry())
        {
            try
            {
                ...
                testcase.assertTrue(
                        SeleniumUtils.iSDisplayed(ExcelProperty.getElementValue(PREDICTIVE_SEARCH, HEADER_LOGO)),
                        "Navigated to Brand Details page", "Not navigated to Brand Details page");
                testcase.pass("functionality of  brands in carousels of 'Search' component on searching for brands.");
                break;
            } catch (Exception e)
            {
                testcase.retry("functionality of  brands in carousels of 'Search' component on searching for brands.",
                        testcase, retry, e);
                e.printStackTrace();
            }
        }
