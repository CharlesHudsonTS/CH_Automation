...
public class MobileMyGarageTest extends AbstractTestCaseReport implements FileConstants
{
    ...
    public void verifyMyGarageRemoveVehicle() throws Exception
    {
        ...
        try
        {
            ...
            // "My Garage remove vehicle link is displaying", "My garage remove
            // vehicle link is not displayed");
            // SeleniumUtils.wait(4);
...
//            MyGaragePage.clickDrivingPerference();
//            SeleniumUtils.wait(4);
//            testcase.assertTrue(MyGaragePage.verifyUsualDrivingStyle(), "Usual Driving Style is displaying",
